const createCard = employee => {
  if(employee.getRole() ==='Engineer') {
      ...
      <div class = "card col-3 m-2 border-0">
          <div class="bg-dark text-light card-header">
              ...
              <h2 class= "text-light text-align-center"><i class="fas fa-glasses"></i>  ${employee.getRole()}</h2>
          </div>
  ...
  if(employee.getRole() ==='Intern') {
      ...
      <div class = "card col-3 m-2 border-0">
          <div class="bg-dark text-light card-header">
              <h2 class= "text-light">${employee.name}</h2>
              <h2 class= "text-light text-align-center"><i class="fas fa-user-graduate"></i>  ${employee.getRole()}</h2>
          </div>
          <div class="bg-secondary card-body">
              <ul class="list-group">
                  <li class="list-group-item">Employee ID: ${employee.getId()} </li>
